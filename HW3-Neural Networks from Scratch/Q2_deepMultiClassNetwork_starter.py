'''
This file is the code for Question 2 of Homework-3
Python Version: 2.7
...
def softmax_cross_entropy_loss_der(Y, cache):
    ...
    o_h=o_h.T    
    # print "o_h=",o_h
    # print "A.shape=",cache["A"].shape
    # print "o_h=",o_h.shape

    dZ= cache["A"]-o_h
    #print "dZ.size=",dZ.shape	    
    #print cache["A"]
    #print "cache.size=",cache["A"].shape
    return dZ
...
def multi_layer_network(X, Y, VD, VL, net_dims, num_iterations=500, learning_rate=0.2, decay_rate=0.01):
    '''
...
def train_validation_split(train_data,train_label):
    ...
    tv_data=np.split(train_data.T,[500,600,1100,1200,1700,1800,2300,2400,2900,3000,3500,3600,4100,4200,4700,4800,5300,5400,5900])
    tvl_data=np.split(train_label.T,[500,600,1100,1200,1700,1800,2300,2400,2900,3000,3500,3600,4100,4200,4700,4800,5300,5400,5900])
...
def main():
    ...
    # plt.imshow(train_data.T[4999].reshape(28,28))    
    # plt.show()
    # plt.imshow(validation_data.T[999].reshape(28,28))
    # plt.show()
